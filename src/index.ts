...
const INPUT_NUMBER = (<HTMLInputElement>document.getElementById('numeroOriginal'));
const ALERT_MESSAGE = (<HTMLInputElement>document.getElementById('alertMessage'));
...
const convertirOtroDecimal = (numeroOriginal: string, baseOriginal: number): string => {
